...
const DeleteConfirm = ({ action, discardFunc, cancelFunc }) => {
	...
	return (
		<div className="">
			<div className="backdrop w-screen h-screen absolute  top-0 left-0">
				<div className="bg-gray-1000 opacity-50 z-10 h-full w-full"></div>
				<div className="flex justify-center">
					<div className="confirmation-box top-1/4 absolute z-20 bg-white shadow-xl px-5 py-10 md:p-6 rounded-lg w-10/12 md:w-2/4 h-64 space-y-8 object-center flex flex-col justify-between">
						<div className="top">
